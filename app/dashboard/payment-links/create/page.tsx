...
export default function CreatePaymentLinkPage() {
  ...
  if (paymentUrl) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-green-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 p-4 sm:p-6">
          ...
          <Card className="bg-white dark:bg-slate-800 p-5 sm:p-8 border-slate-200 dark:border-slate-700">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button
                ...
                className="flex-1 bg-gradient-to-r from-green-700 to-green-500 hover:from-green-800 hover:to-green-600 text-white"
              >
                Create Another
              </Button>
            </div>
