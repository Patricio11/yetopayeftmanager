...
import { Plus, Copy, CheckCircle, ExternalLink, X, DollarSign, FileText } from 'lucide-react';
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        {trigger === 'button' ? (
          <Button className="bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white shadow-lg shadow-green-500/30 hover:shadow-xl hover:shadow-green-500/40 transition-all duration-300">
          ...
          <>
            ...
            <form onSubmit={handleSubmit} className="space-y-5 mt-4">
              ...
              <Button
                type="submit"
                disabled={isLoading}
                className="w-full h-12 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white shadow-lg font-semibold text-base"
              >
                {isLoading ? (
